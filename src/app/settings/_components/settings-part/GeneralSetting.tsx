      ...
      <div className="settings-panel">
        ...
        <div className="settings-form-wrapper">
              ...
              <div className="columns is-multiline">
                ...
                <div className="column is-12">
                  ...
                  <div className="form-text">
                    <p>
                      Hãy chắc chắn điền vào cài đặt vị trí của bạn. Điều này sẽ
                      giúp chúng tôi gợi ý cho bạn những người bạn phù hợp và
                      những địa điểm mà bạn có thể thích.
                    </p>
                  </div>
                </div>
                  ...
                  <>
                    <div className="column is-12">
                      ...
                      <TextArea
                        ...
                        placeholder="Giới thiệu về bản thân của bạn..."></TextArea>
                    </div>
                    <div className="column is-12">
                      {/* <!--Field--> */}
                      <InputHasIcon
          ...
          <div className="illustration">
            ...
            />
            <p>
              Nếu bạn muốn tìm hiểu thêm về cài đặt chung, bạn có thể đọc về nó
              trong <a>hướng dẫn sử dụng.</a>.
            </p>
          </div>
        </div>
      </div>
